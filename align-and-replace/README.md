...
```
./gradlew dependencyInsight --dependency aws-java-sdk --singlepath
```
...
but there is nothing in here about aligned groups, as seen in the subsequent dependencies as `belongs to platform com.amazonaws:com.amazonaws:1.11.702`:
...
com.amazonaws:aws-java-sdk-autoscaling:1.11.702
   ...
   Selection reasons:
      - By constraint : belongs to platform com.amazonaws:com.amazonaws:1.11.702
