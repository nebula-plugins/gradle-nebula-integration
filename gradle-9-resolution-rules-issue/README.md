running `./gradlew build -s` results in

```
* What went wrong:
A problem occurred evaluating root project 'gradle-9-resolution-rules-issue'.
> Project#afterEvaluate(Action) on root project 'gradle-9-resolution-rules-issue' cannot be executed in the current context.
...
* Exception is:
org.gradle.api.GradleScriptException: A problem occurred evaluating root project 'gradle-9-resolution-rules-issue'.
        ...
        at org.gradle.internal.cc.impl.barrier.BarrierAwareBuildTreeWorkPreparer$scheduleRequestedTasks$1.invoke(BarrierAwareBuildTreeWorkPreparer.kt:34)
        at org.gradle.internal.cc.impl.barrier.BarrierAwareBuildTreeWorkPreparer$scheduleRequestedTasks$1.invoke(BarrierAwareBuildTreeWorkPreparer.kt:33)
...
Caused by: org.gradle.api.internal.DefaultMutationGuard$IllegalMutationException: Project#afterEvaluate(Action) on root project 'gradle-9-resolution-rules-issue' cannot be executed in the current context.
        at org.gradle.api.internal.DefaultMutationGuard.createIllegalStateException(DefaultMutationGuard.java:102)
        at org.gradle.api.internal.DefaultMutationGuard.assertEagerContext(DefaultMutationGuard.java:55)
        at org.gradle.api.internal.project.DefaultProject.assertEagerContext(DefaultProject.java:1567)
        at org.gradle.api.internal.project.DefaultProject.afterEvaluate(DefaultProject.java:1105)
        at nebula.plugin.resolutionrules.ResolutionRulesPlugin$apply$2.execute(plugin.kt:266)
        at nebula.plugin.resolutionrules.ResolutionRulesPlugin$apply$2.execute(plugin.kt:101)
        ...
        at org.gradle.api.internal.DefaultNamedDomainObjectCollection.doAdd(DefaultNamedDomainObjectCollection.java:126)
        at org.gradle.api.internal.DefaultDomainObjectCollection.add(DefaultDomainObjectCollection.java:274)
        at org.gradle.api.internal.artifacts.configurations.DefaultConfigurationContainer.createLockedLegacyConfiguration(DefaultConfigurationContainer.java:360)
        at org.gradle.api.internal.artifacts.configurations.DefaultConfigurationContainer.consumableLocked(DefaultConfigurationContainer.java:254)
        at org.gradle.api.plugins.internal.JvmPluginsHelper.createDocumentationVariantWithArtifact(JvmPluginsHelper.java:120)
        at org.gradle.api.plugins.jvm.internal.DefaultJvmFeature.withSourcesJar(DefaultJvmFeature.java:297)
        at org.gradle.jvm.component.internal.DefaultJvmSoftwareComponent.lambda$withSourcesJar$1(DefaultJvmSoftwareComponent.java:82)
        at org.gradle.internal.code.DefaultUserCodeApplicationContext$CurrentApplication$1.execute(DefaultUserCodeApplicationContext.java:124)
        at org.gradle.api.internal.DefaultCollectionCallbackActionDecorator$BuildOperationEmittingAction$1.run(DefaultCollectionCallbackActionDecorator.java:109)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:29)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:26)
        ...
        at org.gradle.api.internal.DefaultMutationGuard$1.execute(DefaultMutationGuard.java:66)
        at org.gradle.api.internal.DefaultDomainObjectCollection.configureEach(DefaultDomainObjectCollection.java:209)
        at org.gradle.jvm.component.internal.DefaultJvmSoftwareComponent.withSourcesJar(DefaultJvmSoftwareComponent.java:80)
        at org.gradle.internal.code.DefaultUserCodeApplicationContext$CurrentApplication$1.execute(DefaultUserCodeApplicationContext.java:124)
        at org.gradle.api.internal.DefaultCollectionCallbackActionDecorator$BuildOperationEmittingAction$1.run(DefaultCollectionCallbackActionDecorator.java:109)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:29)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:26)
        ...
        at org.gradle.api.internal.DefaultDomainObjectCollection.configureEach(DefaultDomainObjectCollection.java:209)
        at org.gradle.api.plugins.internal.DefaultJavaPluginExtension.withSourcesJar(DefaultJavaPluginExtension.java:271)
        at build_232gcw9qj99677s9l1d24el2z$_run_closure3$_closure4.doCall$original(/Users/rperezalcolea/Projects/github/nebula-plugins/gradle-nebula-integration/gradle-9-resolution-rules-issue/build.gradle:17)
        at build_232gcw9qj99677s9l1d24el2z$_run_closure3$_closure4.doCall(/Users/rperezalcolea/Projects/github/nebula-plugins/gradle-nebula-integration/gradle-9-resolution-rules-issue/build.gradle)
        ...
        at org.gradle.api.internal.DefaultDomainObjectCollection.withType(DefaultDomainObjectCollection.java:233)
        at build_232gcw9qj99677s9l1d24el2z$_run_closure3.doCall$original(/Users/rperezalcolea/Projects/github/nebula-plugins/gradle-nebula-integration/gradle-9-resolution-rules-issue/build.gradle:15)
        at build_232gcw9qj99677s9l1d24el2z$_run_closure3.doCall(/Users/rperezalcolea/Projects/github/nebula-plugins/gradle-nebula-integration/gradle-9-resolution-rules-issue/build.gradle)
        at jdk.proxy1/jdk.proxy1.$Proxy82.execute(Unknown Source)
        at org.gradle.internal.code.DefaultUserCodeApplicationContext$CurrentApplication$1.execute(DefaultUserCodeApplicationContext.java:124)
        at org.gradle.api.internal.DefaultCollectionCallbackActionDecorator$BuildOperationEmittingAction$1.run(DefaultCollectionCallbackActionDecorator.java:109)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:29)
        at org.gradle.internal.operations.DefaultBuildOperationRunner$1.execute(DefaultBuildOperationRunner.java:26)
        ...
        at build_232gcw9qj99677s9l1d24el2z.run(/Users/rperezalcolea/Projects/github/nebula-plugins/gradle-nebula-integration/gradle-9-resolution-rules-issue/build.gradle:14)
