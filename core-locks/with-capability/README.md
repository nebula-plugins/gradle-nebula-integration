# Core locking with a capability to act as a replacement and core alignment
...
org.slf4j:log4j-over-slf4j:1.7.10
   ...
   Selection reasons:
      ...
      - Forced
      - By conflict resolution : On capability log4j-capability:log4j-capability use slf4j in place of log4j
